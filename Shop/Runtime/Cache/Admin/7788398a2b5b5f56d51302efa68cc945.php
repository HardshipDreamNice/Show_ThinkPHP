...
<ul>
  <li class="explode" key="02_cat_and_goods" name="menu">
    商品管理        <ul>
          ...
          <li class="menu-item"><a href="<?php echo U('Type/lst');?>" target="main-frame">属性列表</a></li>
          <li class="menu-item"><a href="<?php echo U('Attribute/lst');?>" target="main-frame">所有属性</a></li>
        </ul>
      </li>
