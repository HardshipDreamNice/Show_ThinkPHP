...
<span class="action-span1"><a href="/index.php/Admin/Goods/lst">ECSHOP 管理中心</a> </span><span id="search_id" class="action-span1"> - 商品列表 </span>
<div style="clear:both"></div>
</h1>
    <div class="form-div">
        <form action="" name="searchForm">
            <img src="/Public/Admin/images/icon_search.gif" width="26" height="22" border="0" alt="SEARCH" /> 商品价格
            <input type="text" name="keyword" size="15" /> 关键字
                ...
                <?php foreach ($list as $key => $val): ?>
                    <tr>
                        ...
                        <td align="center">
                            ...
                            <a href="/index.php/Admin/Goods/grecycle/rid/<?php echo ($val["id"]); ?>" title="还原"><img src="/Public/Admin/images/icon_account.gif" width="16" height="16" border="0" /></a>
                            <a href="/index.php/Admin/Goods/delete/did/<?php echo ($val["id"]); ?>" title="彻底删除" onclick="confirm('确定彻底删除？删除后将无法找回...')"><img src="/Public/Admin/images/icon_drop.gif" width="16" height="16" border="0" /></a>
                        </td>
                    </tr>
                    <?php endforeach ?>
            </table>
