        ...
        <div class="block clearfix">
            ...
            <div class="AreaM">
                ...
                <?php foreach ($hotdata as $v): ?>
                    <div class="goodsItem">
                        <a href="/index.php/Home/Index/detail/goods_id/<?php echo ($v["id"]); ?>"><img src="/Public/Uploads/<?php echo ($v["img_sam"]); ?>" alt="<?php echo ($v["goods_name"]); ?>" class="goodsimg"></a><br />
                        <p class="f1"><a href="/index.php/Home/Index/detail/goods_id/<?php echo ($v["id"]); ?>" title="<?php echo ($v["goods_name"]); ?>"><?php echo ($v["goods_name"]); ?></a></p>
                        <font class="market">￥<?php echo ($v["market_price"]); ?>元</font><br />
                        <font class="f1">
