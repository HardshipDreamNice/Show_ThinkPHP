            ...
            <div class="usBox clearfix">
                        ...
                        <table align="left" border="0" cellpadding="3" cellspacing="5" width="100%">
                            <tbody><tr>
                                ...
                                <tr>
                                    <td align="right"></td>
                                    <td>
                                        <img src="/index.php/Home/User/authcode" alt="看不清？点击更换。" onclick="this.src='/index.php/Home/User/authcode/'+ Math.random()" style="cursor:pointer">
                                    </td>
                                </tr>
                                <tr>
                ...
                <div class="usTxt">
                    ...
                    <div style="padding-left: 50px;">
                        ...
                        3. 享受会员积分制度<br />
                        4. 订阅本店商品信息  <br />
                        <a href="/index.php/Home/User/register"><img src="/Public/Home/images/bnt_ur_reg.gif"></a>
                    </div>
                </div>
            </div>
            </div>
