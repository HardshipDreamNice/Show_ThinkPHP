                ...
                <div id="goodsInfo" class="clearfix">
                    <div class="imgInfo">
                        <a style="position: relative; display: block; outline: 0pt none; text-decoration: none; width: 310px; -moz-user-select: none;" href="/Public/Home/images/200905/goods_img/9_P_1241511871575.jpg" id="zoom1" class="MagicZoom MagicThumb" title="诺基亚E66">
                            <img id="sim806035" src="/Public/Uploads/<?php echo $list['img_ori'];?>" alt="诺基亚E66" height="310px" width="310px;" />
                        ...
                        <div class="picture" id="imglist">
                            <a style="outline: 0pt none;" href="/Public/Uploads/<?php echo $list['img_ori'] ;?>" rel="zoom1" rev="<?php echo $list['img_ori'] ;?>" title="">
                                <img src="/Public/Uploads/<?php echo $list['img_sam']; ?>" alt="<?php echo $list['goods_name']; ?>" class="onbg" /></a>
                        </div>
                    </div>
                    ...
                    <div class="textInfo">
                        <form action="javascript:addToCart(9)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY">
                            ...
                            <ul>
                                <li class="clearfix">
                                    <dd>
                                        <strong>商品货号：</strong><?php echo $list['goods_sn'];?>
                                    </dd>
                                </li>
                                <li class="clearfix">
                                    <dd>
                                        <strong>商品库存：</strong>
                                        <?php echo $list['goods_number'];?> 台
                                    </dd>
                                </li>
                                <li class="clearfix">
                                    <dd>
                                ...
                                <li class="clearfix">
                                    <dd>
                                        <strong>上架时间：</strong><?php echo $list['add_time'];?>
                                    </dd>
                                </li>
                                <li class="clearfix">
                                    <dd>
                                ...
                                <li class="clearfix">
                                    <dd>
                                        <strong>市场价格：</strong><font class="market">￥<?php echo $list['market_price'];?>元</font><br />

                                        <strong>本店售价：</strong><font class="shop" id="ECS_SHOPPRICE">￥<?php echo $list['shop_price'];?>元</font><br />
                                        <strong>注册用户：</strong><font class="shop" id="ECS_RANKPRICE_1">￥<?php echo $list['shop_price'];?>元</font><br />
                                        <strong>vip：</strong><font class="shop" id="ECS_RANKPRICE_2">￥<?php echo $list['shop_price'];?>元</font><br />
                                    </dd>
                                </li>
                                <li class="clearfix">
                                    <dd>
